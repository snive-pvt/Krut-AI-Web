    ...
    <div>
        ...
        <div className='bg-white mx-[22px]  lg:mx-36 rounded-2xl my-10 min-h-[36rem] 2xl:min-h-[50rem] md:flex block'>
            ...
            <div className=' min-h-[25rem]  w-[46%] mx-5  my-5'>
                ...
                <div className=' min-h-[16rem] 2xl:min-h-[25rem] mx-2 my-8 2xl:my-12'>
                     ...
                     <div className='flex gap-3 2xl:gap-4'>
                        ...
                        <input id='firstname' className='placeholder:px-2 2xl:placeholder:text-sm border border-gray-400 rounded h-9 2xl:h-16' type="text" placeholder='First Name' />
                        </div>
                        <div className='h-14 2xl:h-16 flex flex-col w-[45%]'>
                        <label htmlFor="firstname" className='text-xs 2xl:text-sm font-medium'>Last Name</label>
                        <input className='placeholder:px-2 2xl:placeholder:text-sm border border-gray-400 rounded h-9 2xl:h-16' type="text" placeholder='Last Name'/>
                        </div>
                     ...
                     <div className='my-3 2xl:my-6'>
                        ...
                        <input id='email' className='placeholder:px-2 2xl:placeholder:text-sm border border-gray-400 rounded h-9 2xl:h-16' type="text" placeholder='Email' />
                        </div>
                        <div className='mb-2 2xl:mb-5 h-14 2xl:h-16 flex flex-col w-[92%]'>
                        <label htmlFor="phonenumber" className='text-xs 2xl:text-sm font-medium'>Phone number</label>
                        <input id='phonenumber' className='placeholder:px-2 2xl:placeholder:text-sm border border-gray-400 rounded h-9 2xl:h-16' type="tel" placeholder='Phone number' />
                        </div>
                        ...
                        <input id='message' className='placeholder:px-2 2xl:placeholder:text-sm border border-gray-400 rounded h-9 2xl:h-16' type="text" placeholder='Message' />
                        </div>
                     </div>
            ...
            <div className=' min-h-[25rem] 2xl:min-h-[50rem] w-[54%] rounded-2xl flex items-center' style={{background:'#F2F2F2'}}>
              ...
              <img className='object-cover 'src={ContactUs} alt="" style={{ width: '35em', height: '35em' }}/>
              </div>
